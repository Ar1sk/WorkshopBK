...
with open("/Users/ziyad6092/Documents/Kuliah/Workshop BK/WorkshopBK/heart+disease/hungarian.data", encoding='Latin1') as file:
...
model = pickle.load(open("/Users/ziyad6092/Documents/Kuliah/Workshop BK/heart+disease/modelXGB.pkl", 'rb'))
